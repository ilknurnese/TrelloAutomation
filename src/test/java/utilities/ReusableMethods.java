...
//        public static final String path = date.toString();
    ...
    public static List<String> getElementsText(By locator) {
        List<WebElement> elems = GWD.getDriver().findElements(locator);
        List<String> elemTexts = new ArrayList<>();
...
//   waitFor(5);  => waits for 5 second
    ...
    public static WebElement fluentWait(final WebElement webElement, int timeout) {
        ...
        FluentWait<WebDriver> wait = new FluentWait<WebDriver>(GWD.getDriver())
    ...
    public static void doubleClick(WebElement element) {
        new Actions(GWD.getDriver()).doubleClick(element).build().perform();
    }
    /**
     * @param element
     * @param check
    ...
    public static void verifyElementDisplayed(By by) {
        try {
            Assert.assertTrue("Element not visible: " + by, GWD.getDriver().findElement(by).isDisplayed());
    ...
    public static void verifyElementNotDisplayed(By by) {
        try {
            Assert.assertFalse("Element should not be visible: " + by, GWD.getDriver().findElement(by).isDisplayed());
        } catch (NoSuchElementException e) {
            e.printStackTrace();
        }
    }
